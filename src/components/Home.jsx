          ...
          <div class="container px-auto py-6 mx-auto flex flex-wrap flex-col">
            <div class="flex mx-auto flex-wrap ">
              <button>
                  ...
                  >
                  <img class="w-5 h-5 mr-3" src={home} alt="Home icon"/>
                  Home
                  </a>
              </button>
              <button>
                <a
                  ...
                  class="sm:px-6 py-3 w-1/2 sm:w-auto hover:bg-gray-200 justify-center sm:justify-start border-b-2 title-font font-medium inline-flex items-center leading-none tracking-wider rounded-t"
                >
                  <img class="w-5 h-5 mr-3" src={skill} alt="Skills icon"/>
                  Skills
                </a>
              </button>
              <button>
                <a
                  ...
                  class="sm:px-6 py-3 w-1/2 sm:w-auto hover:bg-gray-200 justify-center sm:justify-start border-b-2 title-font font-medium inline-flex items-center leading-none tracking-wider rounded-t"
                >
                  <img class="w-5 h-5 mr-3" src={work} alt="works icon"/>
                  Work Experience
                </a>
              </button>
              <button>
                <a
                  ...
                  class="sm:px-6 py-3 w-1/2 sm:w-auto hover:bg-gray-200 justify-center sm:justify-start border-b-2 title-font font-medium inline-flex items-center leading-none tracking-wider rounded-t"
                >
                  <img class="w-5 h-5 mr-3" src={project} alt="Projects icon"/>
                  Projects
                </a>
              </button>
              <button>
                ...
                >
                  ...
                  <img class="w-5 h-5 mr-3" src={internship} alt="Internships icon" />
                  Internships
                </a>
              </button>
            </div>
              ...
              <div class="flex flex-col text-center w-full">
                ...
                >
                  ...
                  <a
                    aria-label="Leetcode"
                    class="-m-1.5 rounded-md p-1.5 transition-all duration-300 hover:text-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500 sm:-m-3 sm:p-3"
                    href="https://leetcode.com/u/prernapandey2550/"
                    title="Leetcode"
                  >
                    <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M35.6 33.4L28 41c-1.1 1.1-2.9 1.1-4 0L10.6 27.6c-1.1-1.1-1.1-2.9 0-4L24 10c1.1-1.1 2.9-1.1 4 0l4.6 4.6-3 3L25 13l-11 11 11 11 6.6-6.6 4 4z"/>
                    <path d="M31 24h10v4H31z"/>
                  </svg>
                  </a>
